...
class TestBlocks(unittest.TestCase):
    def test_block_to_blocktype(self):
        ...
        self.assertEqual(blocks.block_to_blocktype("1. olist"), blocks.BlockType.OLIST)
        self.assertEqual(blocks.block_to_blocktype("paragraph"), blocks.BlockType.PARAGRAPH)
        self.assertEqual(blocks.block_to_blocktype("1. olist\n2. olist2"), blocks.BlockType.OLIST)
        self.assertEqual(blocks.block_to_blocktype("1. olist\n3. olist2"), blocks.BlockType.PARAGRAPH)
        self.assertEqual(blocks.block_to_blocktype("> quote\nnot a quote"), blocks.BlockType.PARAGRAPH)
